...
export function TransferSuccessScreen({ navigation, route }: Props) {
  ...
  const { amount, feeUsd, walletId, transferRef, destination, completedAt, note } = route.params;
  ...
  return (
    <Screen scroll>
      ...
      >
        ...
        <Text style={styles.heroTitle}>Funds sent successfully</Text>
        <Text style={styles.heroSubtitle}>
          The transfer has been submitted and tracking is available in your activity.
        </Text>
      </LinearGradient>
      ...
      <GlassCard style={styles.summaryCard}>
        ...
        <View style={styles.row}>
          ...
          <Text style={styles.val}>{transferRef}</Text>
        </View>
        <View style={styles.row}>
          <Text style={styles.key}>Sent at</Text>
      ...
      <AppButton title="Send again" onPress={() => navigation.replace('Transfer')} />
      <AppButton
        title="View activity"
        variant="ghost"
